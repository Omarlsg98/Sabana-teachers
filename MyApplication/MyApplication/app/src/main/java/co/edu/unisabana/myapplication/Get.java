...
public class Get {
    ...
    static public void getSalones (final Context t, int idedificio, int idpiso) {
        Select.selectSalon(t, idedificio, idpiso, new AsyncResponse() {
                @Override
                public void processFinish(String s) {
                    ArrayList<Salon> salonList = new JsonConverter<Salon>().toArrayList(s, Salon.class);
                    //MOSTRAR SALONES EN ACTIVIDAD
                }
            });
    }
