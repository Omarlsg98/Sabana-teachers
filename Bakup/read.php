<?PHP
	...
	if(isset($_POST['select']) && $_POST['select'] == "salon"){
		$dato1 = $_POST['dato1'];	
		$dato2 = $_POST['dato2'];	
		$query = "SELECT * FROM salon p WHERE Edificio_has_Piso_Edificio_idEdificio = '$dato1' AND Edificio_has_Piso_Piso_idPiso = '$dato2';";
	}
	...
	if(isset($_POST['select']) && $_POST['select'] == "piso"){
		$dato1 = $_POST['dato1'];
		$query = "SELECT max(numero) FROM piso p WHERE idpiso IN (
